...
abstract class BaseRepository<T, S>(
    ...
    private suspend fun FlowCollector<Async<T>>.load(dbData: T? = null, type: S?) {
        dbData?.let {
            // ****** VIEW CACHE ******
